      ...
      <div class="article-box margin-bottom-xxl">
        ...
        <div class="article-header padding-m bg-white">
          ...
          <div class="article-content margin-top-m">
            <img class="img-cover" v-lazy="$filters.img(entity.coverImage ? entity.coverImage : (entity.coverImagePath ? entity.coverImagePath : '') ,'@160h_300w_1e_1c')" alt="">
...
//              }
    ...
    methods: {
      ...
      report(targetId, type) {
        ...
        this.$messagebox.prompt(" ","举报",options).then(({ value, action }) => {
          if(action === 'confirm') {
            let _params = {
              'target_id': _targetId,
              'target_type': _type,
            ...
            this.$http.post(`${this.$apihost}/community/report`,_params)
              .then((res) => {
      ...
      del(id) {
        this.$messagebox({
          ...
          if(action === 'confirm') {
            this.$http.del(`${this.$apihost}/community/reply/${id}/remove`)
              .then((res) => {
