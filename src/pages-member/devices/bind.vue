  ...
  <div>
    <app-view :hasFooter="false">
      ...
      <div class="form-group margin-top">
        ...
        <div class="flex padding-m padding-left-zero border-bottom"
             @click.stop="selectAddress()">
          <div style="width: 105px">联系地址</div>
        ...
        <!--<v-input type="text" class="form-field required" name="purchaseChannel" label="购买渠道" placeholder="请填写购买渠道"
...
<script type="text/javascript">
  ...
  export default {
    ...
    created() {
      ...
      let _deviceData = that.$route.query && that.$route.query.data;
      if(_deviceData) {
