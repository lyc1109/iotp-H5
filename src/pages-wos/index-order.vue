          ...
          <div class="order-title padding-m flex valign-center border-bottom">
              <span class="font-s">
                <span v-if="order.orderType === 'lease'">
                  <span class="order-type type-1" v-if="order.leaseFeature === 'personal'">个</span>
                  <span class="order-type type-2" v-else-if="order.leaseFeature === 'company'">商</span>
                </span>
                ...
                <span v-else class="order-type type-5">无</span>
              </span>
          ...
          <div class="order-content padding-m">
            <div class="font-bold-400 font-m flex font-family-num">
              ...
              <div class="margin-left-l color-primary">
                ...
                <span class="color-blue-2 font-bold-400" @click.prevent="phoneCall(order.contactMobile)">{{ order.contactMobile }}</span>
              </div>
            </div>
            ...
            <div class="bg-light margin-top-m border-radius padding flex">
              <div class="image-product border-radius border valign-center bg-white">
                <img v-lazy.container="$filters.img(order.productImage,'!q70')" :src="$filters.img(order.productImage,'!q70')" alt="">
              </div>
