  ...
  <div>
    <app-view :hasFooter="true">
      <div class="logs-box">
        ...
        <div class="contact-info padding-m">
          <div class="title font-m margin-bottom-s font-bold-400">
            ...
            <a class="margin-left-m" :href="'tel:'+ entity.contactMobile">
              <i class="icon iconfont color-primary margin-right icon-IOT-dh"></i>{{ entity.contactMobile }}
            </a>
            <a v-if="entity.contactTelephone !== null" class="margin-left-m" :href="'tel:'+ entity.contactTelephone">
              <i class="icon iconfont color-primary margin-right icon-IOT-dh"></i>{{ entity.contactTelephone }}</a>
          </div>
          <div class="location">
            <i class="iconfont icon-IOT-dz font-light"></i>
            <span>{{ entity.serviceAddress }}</span>
            <div style="display: inline-block;">
              <actions type="copy-btn" :address="entity.serviceAddress"></actions>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="margin-top order-info bg-white">
        <div class="flex order-info-item">
          <div class="flex-item-2 margin-right-m">
            <div class="product-image valign-center border border-radius">
              <img v-lazy="$filters.img(productImage,'!q70')">
            </div>
          </div>
          <div class="product-info flex-item flex">
              <div class="font-m font-title text-wrapper-overline">
                <span v-if="entity.orderType === 'common'" class="order-productname font-bold-400">{{ entity.productName }}</span>
                <span v-if="entity.orderType === 'lease'" class="order-productname font-bold-400">{{ entity.leaseProduct.name }}</span>
              </div>
              ...
              <div v-if="entity.orderType === 'lease'" class="font-s font-lighter margin-top">产品代码：{{ entity.leaseProduct.code ? entity.leaseProduct.code : '无' }}</div>
        ...
        <div class="order-info-item flex">
          ...
          <div>
            ...
            <span v-else-if="entity.orderType === 'install'">
              <span v-if="entity.leaseProduct">租赁装机</span>
        ...
        <!--<div class="order-info-item flex" v-else-if="entity.orderType === 'install'">-->
          <!--<div class="font-light title-box">装机数量</div>-->
          <!--<div class="flex-item"></div>-->
          <!--<div>-->
            <!--<span>{{ entity.deviceCount }}</span>-->
          <!--</div>-->
        ...
        <div v-if="entity.orderType === 'common'">
          <div class="padding-m padding-left-zero margin-left-m font-light title-box border-bottom flex">
            图片附件
      ...
      <!--<div v-if="hasImage">-->
        <!--<div class="padding">图片附件</div>-->
        <!--<div class="cell-group">-->
          <!--<div class="container-fluid">-->
            <!--<div class="row">-->
              <!--<div class="col-xs-3 col-zero order-images" v-for="img in entity.images">-->
                <!--<a class="fancybox" rel="group" :href="img">-->
                  <!--<div class="placeholder margin-bottom-s margin-top-s bg-box-48"-->
                       <!--:style="'background-image:url(' + img +');' +-->
                      <!--'background-size: 100% 100%;' +-->
                      <!--'width:50px;height:50px;display:inline-block;'"></div>-->
                <!--</a>-->
              <!--</div>-->
            <!--</div>-->
          <!--</div>-->
      ...
      this.$nextTick(() => {
        ...
        this.$http.get(`${this.$woshost}/workorders/${this.orderId}/devices`)
          .then((device) => {
            ...
            this.entity.deviceDataLen = device.length;
          })
